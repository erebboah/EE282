...
p1 = EnhancedVolcano(edger_result_heart,
                    ...
                    title = 'Differentially expressed microRNAs in heart tissue\n(upregulated = positive LFC)',
                    subtitle = '-Log10(p-val) < 10, |Log2FC| > 4\n354 microRNAs total',
                    x = 'logFC',
                    y = 'PValue',
                    FCcutoff = 4,
                    pCutoff = 1e-10,
...
p2 = EnhancedVolcano(edger_result_sc,
                     ...
                     title = 'Differentially expressed microRNAs in stem cells\n(upregulated = positive LFC)',
                     subtitle = '-Log10(p-val) < 8, |Log2FC| > 6\n587 microRNAs total',
                     x = 'logFC',
                     y = 'PValue',
                     FCcutoff = 6,
                     pCutoff = 1e-8,
...
save(edger_result_sc, file="rdata/edger_result_stemCells_vs_allotherCLDCL.csv", quote=F)
